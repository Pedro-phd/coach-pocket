    ...
    <div className='flex flex-col gap-4'>
      ...
      <div className="grid md:grid-cols-[3fr_1fr] gap-4 p-3 md:p-5">
        ...
        <div 
          ...
          <p className="text-white font-semibold text-lg md:text-2xl">Novo Aluno</p>
          <p className="text-white font-medium text-xs md:text-sm">Adicione um novo aluno no seu time!</p>
          <Button 
            className="flex gap-2 md:mt-4 bg-indigo-800 text-white hover:bg-indigo-900 hover:text-white" 
            size='sm' 
            variant='ghost' onClick={() => push('/dashboard/member/new')}>
